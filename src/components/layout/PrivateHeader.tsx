...
import { LogOut, User, LayoutDashboard, Menu, X, ExternalLink } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <nav className="flex flex-col gap-2 pt-4">
            ...
            {/* Added: Gå till startsidan (Mobile) */}
            <Link
              to="/"
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary-foreground/80 hover:text-primary-foreground hover:bg-navy-light rounded-lg transition-colors"
              onClick={() => setMobileMenuOpen(false)}
            >
              <ExternalLink className="h-4 w-4" />
              Gå till startsidan
